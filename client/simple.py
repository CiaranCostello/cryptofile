...
encrypted_for_snowden   = pubkey_snowden.encrypt(message_to_snowden.encode('utf-8'), 32)    #from PyTN
encrypted_for_pytn      = pubkey_pytn.encrypt(message_to_pytn.encode('utf-8'), 32)          #from Snowden
